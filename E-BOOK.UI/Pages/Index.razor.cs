...
namespace E_BOOK.UI.Pages
{
    public partial class Index
    {
        ...
        protected int CurrentPage3 = 1;
        protected int PageSize3 = 6;
        ...
        {
            if (_Book4.TotalPages >= CurrentPage3)
            {
                _Book4 = await _bookHttpService.RecentBooks(CurrentPage3++, PageSize3);
            }
        }
        ...
        public async Task HandlePrev2()
        {
            ...
            CurrentPage3--;
            _Book4 = await _bookHttpService.RecentBooks(CurrentPage3, PageSize);
        }
